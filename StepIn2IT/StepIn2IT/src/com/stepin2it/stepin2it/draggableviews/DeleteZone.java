package com.stepin2it.stepin2it.draggableviews;
 ...
 */
			...
			int yOffset, DragView dragView, Object dragInfo)
	{
		if (isEnabled())
		{
			...
			if (dragView.getId() == 1)
			{
			toast("Feeling very sad");
			}
			else if (dragView.getTag().equals("face2"))
			{
				toast("Feeling sad");
			}
			else if (dragView.getTag().equals("face3"))
			{
				toast("Feeling ok");
			}
			else if (dragView.getTag().equals("face4"))
			{
				toast("Feeling happy");
			}
			else if (dragView.getTag().equals("face5"))
			{
				toast("Feeling very happy");
			}
			*/
		...
		if (d != null)
		{
			...
			// toast(String.valueOf(sourceView.getTag()));
			if (sourceView.getTag().equals("face1"))
			{
				toast("Feeling very sad");
			}
			else if (sourceView.getTag().equals("face2"))
			{
				toast("Feeling sad");
			}
			else if (sourceView.getTag().equals("face3"))
			{
				toast("Feeling ok");
			}
			else if (sourceView.getTag().equals("face4"))
			{
				toast("Feeling happy");
			}
			else if (sourceView.getTag().equals("face5"))
			{
				toast("Feeling very happy");
			}
		}
