package com.stepin2it.stepin2it.draggableviews.checkinstepone;
...
public class SelectZone extends ImageView implements DropTarget
{
 ...
 */
	...
	public SelectZone(Context context)
	{
		super(context);
	}

	public SelectZone(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public SelectZone(Context context, AttributeSet attrs, int style)
	{
