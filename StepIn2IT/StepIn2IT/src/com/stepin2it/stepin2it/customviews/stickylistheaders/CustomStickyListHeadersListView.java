package com.stepin2it.stepin2it.customviews.stickylistheaders;
...
public class CustomStickyListHeadersListView extends ListView {

	public interface OnHeaderClickListener {
		public void onHeaderClick(CustomStickyListHeadersListView l, View header,
		...
		public void onHeaderClick(View header, int itemPosition, long headerId) {
			if (mOnHeaderClickListener != null) {
				mOnHeaderClickListener.onHeaderClick(
						CustomStickyListHeadersListView.this, header, itemPosition,
						headerId, false);
			}
		}
	};
	...
	public CustomStickyListHeadersListView(Context context, AttributeSet attrs) {
