package com.stepin2it.stepin2it.customviews;
...
{
	private String TAG = "TriToggleButton";
...
//			Log.d(DEBUGTAG, "   Setting Toggle state to " + state);
	...
	public void nextState()
	{
		...
		setButtonText();
		Log.d(TAG, "   Setting Toggle state to " + _state);
	...
	private void setButtonText()
	{
		switch(_state)
		{
			case 0: this.setText("No");
					break;
			case 1: this.setText("Yes");
					break;
			case 2: this.setText("NA");
					break;
			default: this.setText("No"); // Should never happen, but just in case
					break;
		}
	}
