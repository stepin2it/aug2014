...
public class CircleLayoutEmotions extends ViewGroup {
	...
	public CircleLayoutEmotions(Context context) {
		this(context, null);
	}
	
	@SuppressLint("NewApi")
	public CircleLayoutEmotions(Context context, AttributeSet attrs) {
		super(context, attrs);
