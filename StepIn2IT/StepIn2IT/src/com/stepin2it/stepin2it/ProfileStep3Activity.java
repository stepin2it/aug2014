...
public class ProfileStep3Activity extends SherlockActivity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		buttonViewTOC = (Button) this.findViewById(R.id.buttonViewTOC);
		buttonViewTOC.setOnClickListener(new View.OnClickListener()
		{
			
			@Override
			public void onClick(View v)
			{
				Intent intent = new Intent(ProfileStep3Activity.this, ProfileStep4Activity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		Intent intent = new Intent(ProfileStep3Activity.this,
				MainActivity.class);
		startActivity(intent);
