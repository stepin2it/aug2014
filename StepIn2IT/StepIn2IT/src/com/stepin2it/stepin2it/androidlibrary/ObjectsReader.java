...
public class ObjectsReader
{
    ...
    private static PhotoResponse responseObject = null;
   
    public static PhotoResponse readPhotoResponse(String jsonFileUrl)
    {
        ...
        Type listType = new TypeToken<PhotoResponse>()
        {
        }.getType();
