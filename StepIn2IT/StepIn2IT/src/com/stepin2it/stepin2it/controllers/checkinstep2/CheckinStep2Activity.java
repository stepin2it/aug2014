package com.stepin2it.stepin2it.controllers.checkinstep2;
...
public class CheckinStep2Activity extends SherlockActivity implements View.OnLongClickListener,
 ...
 */
	...
	public void addNewImageToScreen(int resourceId)
	{
		...
		if ( (imageHolder != null) && (imageHolder2 != null)&& (imageHolder3 != null) && (imageHolder4 != null))
		{
			...
			newView.setImageResource(R.drawable.face1);
			...
			newView2.setImageResource(R.drawable.face2);
			...
			newView3.setImageResource(R.drawable.face3);
			...
			newView4.setImageResource(R.drawable.face4);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_checkin_step2);
		...
		buttonContinue.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
//				Intent intent = new Intent(CheckinStep2Activity.this, HomeActivity.class);
				Intent intent = new Intent(CheckinStep2Activity.this, CheckinStep3Activity.class);
