package com.stepin2it.stepin2it.controllers.checkinstep5;
...
public class CheckinStep5Activity extends SherlockActivity implements
		WheelModel.Listener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_checkin_step5);
		...
		buttonContinue.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				// HomeActivity.class);
				Intent intent = new Intent(CheckinStep5Activity.this,
						CheckinStep6Activity.class);
