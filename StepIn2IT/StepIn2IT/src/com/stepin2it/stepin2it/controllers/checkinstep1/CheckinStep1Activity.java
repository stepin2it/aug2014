...
public class CheckinStep1Activity extends SherlockActivity implements View.OnLongClickListener,
 ...
 */
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		buttonSkip.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				Intent intent = new Intent(CheckinStep1Activity.this, CheckinStep2Activity.class);
