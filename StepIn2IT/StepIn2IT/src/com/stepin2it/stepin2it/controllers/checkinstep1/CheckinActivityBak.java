...
import com.stepin2it.stepin2it.customlayouts.SemiCircleLayout;
import com.stepin2it.stepin2it.customlayouts.SemiCircleLayout.LayoutParams;
import com.stepin2it.stepin2it.draggableviews.DeleteZone;
import com.stepin2it.stepin2it.draggableviews.DragController;
import com.stepin2it.stepin2it.draggableviews.DragLayer;
import com.stepin2it.stepin2it.draggableviews.DragSource;
import com.stepin2it.stepin2it.draggableviews.ImageCell;
import com.stepin2it.stepin2it.draggableviews.ImageCellAdapter;
...
public class CheckinActivityBak extends Activity implements View.OnLongClickListener,
 ...
 */
	...
	public void addNewImageToScreen(int resourceId)
	{
		...
		SemiCircleLayout imageHolder = (SemiCircleLayout) findViewById(R.id.image_source_frame);
		SemiCircleLayout imageHolder2 = (SemiCircleLayout) findViewById(R.id.image_source_frame2);
		SemiCircleLayout imageHolder3 = (SemiCircleLayout) findViewById(R.id.image_source_frame3);
		if ( (imageHolder != null) && (imageHolder2 != null))
		{
			SemiCircleLayout.LayoutParams lp = new SemiCircleLayout.LayoutParams(
	...
	public void addNewImageToScreen()
	{
		...
		int m = mImageCount % 3;
		if (m == 1)
			resourceId = R.drawable.face4x;
		else if (m == 2)
			resourceId = R.drawable.face2x;
