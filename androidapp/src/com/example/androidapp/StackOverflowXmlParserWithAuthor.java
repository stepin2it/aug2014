 ...
 */
public class StackOverflowXmlParserWithAuthor {
	...
	public static class Entry {
		...
		private Entry(String title, String link, Author author, String summary) {
			this.title = title;
			this.link = link;
			this.author = author;
	...
	private Entry readEntry(XmlPullParser parser)
		...
		return new Entry(title, link, author, summary);
	}
	...
	private Author readAuthor(XmlPullParser parser) throws IOException,
			XmlPullParserException {
		...
		author = new Author(authorname, uri);
		return author;
	}
	...
	// Processes summary tags in the feed.
	private String readUri(XmlPullParser parser) throws IOException,
			XmlPullParserException {
